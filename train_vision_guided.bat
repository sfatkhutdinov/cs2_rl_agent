@echo off
echo ====================================================
echo Cities: Skylines 2 Vision-Guided RL Agent Training
echo ====================================================
echo.
...
if %errorlevel% neq 0 (
    ...
    echo Please start Ollama and ensure the granite3.2-vision model is available.
    echo You can download it with: ollama pull granite3.2-vision:latest
    
    choice /C YN /M "Do you want to continue anyway"
    if %errorlevel% equ 2 exit /b
)

REM Run the vision-guided training script
echo Starting vision-guided training...
python train_vision_guided.py --config config/vision_guided_config.yaml
