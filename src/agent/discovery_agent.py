"""
Discovery Agent - Agent responsible for exploring and discovering UI elements
...
class DiscoveryAgent:
    """
    An agent focused on discovering UI elements and menu navigation
    in the game environment.
    """
    ...
    def __init__(self, environment: gym.Env, config: Dict[str, Any]):
        ...
        Args:
            environment: The discovery environment
        ...
        # Set up paths
        self.log_dir = config.get("paths", {}).get("log_dir", "logs/discovery")
        self.model_dir = config.get("paths", {}).get("model_dir", "models/discovery")
